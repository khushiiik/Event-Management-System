...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
  ...
  <ul class="navbar-nav px-3">
    <li class="nav-item text-nowrap">
      ...
      <a href='/logout'><button class="btnn" id="logout-btn" style="color: #f5f6fa">logout</button></a>
    </li>
  </ul>
</nav>
            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
              <div class="sidebar-sticky">
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="/vendordisplay">
                      <span data-feather="users"></span>
                      Vendor Panel
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/feedbackdisplay">
                  ...
                  <li class="nav-item">
                    ...
                    <a class="nav-link" href="/packagedisplay">
